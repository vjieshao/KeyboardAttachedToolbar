...
podName="KeyboardAttachedToolbar"
homepage="https://github.com/vjieshao"
httpsRepo="git@github.com:vjieshao/KeyboardAttachedToolbar.git"
podspecFilePath="./KeyboardAttachedToolbar.podspec"
